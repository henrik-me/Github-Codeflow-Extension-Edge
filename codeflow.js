...
if (discussionHeaders !== null)
{
    AddCodeflowElement(discussionHeaders);
}

function AddCodeflowElement(discussionHeaders)
{
    ...
    var htmlToInsert = " <a id='CodeFlow' href='codeflow:open?pullrequest=" + prlink 
    ...
    codeflowElement.innerHTML = htmlToInsert;
